package com.wh.springframework.aop.support;

import com.wh.springframework.aop.aspect.AfterReturningAdviceInterceptor;
import com.wh.springframework.aop.aspect.AfterThrowingAdviceInterceptor;
import com.wh.springframework.aop.aspect.MethodBeforeAdviceInterceptor;
...
public class AdvisedSupport {
    ...
    private void parse() {
        ...
        String pointCut = config.getPointCut()
                ...
                .replaceAll("\\(", "\\\\(")
                .replaceAll("\\)", "\\\\)");
        //pointCut=public .* com.wh.helloworld.service..*Service..*(.*)
